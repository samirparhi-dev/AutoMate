...
# Ensure Desktop directory exists and copy desktop file
...
# Create custom Brave browser wrapper
...
# Create brave symlink
cp /usr/bin/brave-browser /usr/bin/brave

# Update x-www-browser
